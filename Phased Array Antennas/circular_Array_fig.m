...
polar(angler,ArraydB - min(ArraydB))
title ('Power pattern [dB] normaled to Min value 0')
%
...
polar(angler,Element,'b-')
title('Element normalized E field [dB]')
subplot(2,2,2)
% polardb(angler,Array,'b-')
polar(angler,ArraydB - min(ArraydB),'b-')

title(' Array Factor normalized [dB] normaled to Min value 0')
subplot(2,2,3)
% polardb(angler,EtotalR,'b-'); % polar plot
polar(angler,EtotalRdB - min(EtotalRdB),'b-'); % polar plot
title('Total normalized E field [dB] normaled to Min value 0')