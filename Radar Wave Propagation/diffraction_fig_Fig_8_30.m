...
Rd1 = linspace(75e3, 210.1e3, 100); % slant range 3 to 55 Km 500 points
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
axis tight
title('\bffrequency = 428 MHz; ht = 3000 m; hr = 200 m')
R = linspace(210.1e3,350e3,100); % range in Km
nt =100; % number of point used in calculting infinite series Maximum is 100
F = diffraction(freq, hr, ht,R,nt);
figure(3)
plot(R/1000,10*log10(abs(F).^2),'k','linewidth',1)
grid
xlabel('\bfRange - Km')
ylabel('\bfOne way propagation factor - dB')
